from presentation.mcp.category_tools import register_medical_category_tools
from presentation.mcp.core import ecg_service, medical_category_service, mcp, patient_service, upload_provider
...
register_medical_category_tools(mcp, medical_category_service)
